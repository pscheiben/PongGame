...
void clear_life(int x, int y);   //clear the middle of the symbol
void check_player1_score(int playerscore);  //check player 1 score
void check_player2_score(int playerscore);  //check player 2 score
